...
$query="insert into usuario (login, senha,tipoUsuario, nome,sobrenome,email) values ('$Login','$Senha','$Tipo','$Nome','$Sobrenome','$Email')";/*pega as variáveis e inseri no banco-- o nome entre os parantes é igual aos que estão no banco o nome ex: Contato tem que ser igual ao do banco */
